<?php
    ...
    $sql = "SELECT * FROM blogs WHERE blog_id = '$blog_id' AND creator_email = '" . $_SESSION['email'] . "'";
    $result = $conn->query($sql);

    if ($result->num_rows == 0) {
        echo "Error: Blog not found or you do not have permission to edit this blog.";
        exit();
    }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
        ...
        $update_sql = "UPDATE blogs SET title = '$title', description = '$description', event_date = '$event_date', privacy_filter = '$privacy_filter' WHERE blog_id = '$blog_id' AND creator_email = '" . $_SESSION['email'] . "'";
